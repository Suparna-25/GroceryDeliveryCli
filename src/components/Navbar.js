...
function Navbar() {
  ...
  <a  href="/categoryDashboard" className="nav-item nav-link">Category</a>
  ...
  <div className="navbar-nav ml-auto action-buttons">
			<div className="nav-item dropdown show"></div>
				<a href="#" data-toggle="dropdown" className="nav-link dropdown-toggle mr-4" aria-expanded="true">Login</a>
